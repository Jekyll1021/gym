...
class PegInsertRotationEnv(robot_env.RobotEnv):
    ...
    def __init__(
        ...
        super(PegInsertRotationEnv, self).__init__(
    ...
    def render(self, mode='rgd_array', width=500, height=500):
        return super(PegInsertRotationEnv, self).render(mode, width, height)
