...
class CamGraspEnv(grasp_env.GraspEnv, utils.EzPickle):
    def __init__(self, reward_type='dense', goal_type='fixed', cam_type='fixed', gripper_init_type='fixed', act_noise=False, obs_noise=False, open_loop=True):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
        ...
        grasp_env.GraspEnv.__init__(
            ...
            joint_training=False, open_loop=open_loop)
